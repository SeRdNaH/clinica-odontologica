<%-- 
    Document   : bodyInicio
    Created on : 7 jul. 2026, 08:02:01
    Author     : alonso
--%>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOdontologos"
                    ...
                    <i class="fas fa-solid fa-briefcase-medical"></i>
                ...
                <div id="collapseOdontologos" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="altaOdontologo.jsp">Registrar</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePacientes" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-border.html">Consultar</a>
                        <a class="collapse-item" href="utilities-animation.html">Editar</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsuarios" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones</h6>
                        <a class="collapse-item" href="altaUsuario.jsp">Registrar</a>
                        <a class="collapse-item" href="svUsuario">Consultar</a>
                        <a class="collapse-item" href="">Editar</a>
                        <a class="collapse-item" href="">Eliminar</a>
                    </div>
                </div>
